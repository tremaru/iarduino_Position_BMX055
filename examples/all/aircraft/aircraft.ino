...
//  выполнить калибровку см. пример: all/aircraft_calib     //   Гироскоп измеряет угловую скорость вокруг собственных осей, он определяет воздействие момента внешней силы.
