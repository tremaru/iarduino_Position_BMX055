...
//  выполнить калибровку см. пример: all/angle_calib        //   Гироскоп измеряет угловую скорость вокруг собственных осей, он определяет воздействие момента внешней силы.
