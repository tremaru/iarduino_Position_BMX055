...
// (только КРЕН и ТАНГАЖ, без КУРСА)                           //   АКСЕЛЕРОМЕТР: измеряет проекцию кажущегося ускорения, которое является геометрической разницей между истинным ускорением и ускорением силы гравитации (g).
