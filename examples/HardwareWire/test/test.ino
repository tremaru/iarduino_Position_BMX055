// ПРИМЕР САМОТЕСТИРОВАНИЯ МОДУЛЯ:                          // Самотестирование выполняется на аппаратном уровне, к модулю не должны прикладываться внешние силы. Модуль должен быть неподвижен.
...
//   Выводим подсказку по тестированию:                     // Чем выше диапазон и частота, тем ниже точность.
     Serial.println("САМОТЕСТИРОВАНИЕ МОДУЛЯ:");            //
     Serial.println("Модуль должен быть неподвижен.");      //
     Serial.println("Положение модуля не имеет значения."); //
     Serial.println("Тестирование начнётся через 5 сек.");  //
     delay(5000);                                           //
